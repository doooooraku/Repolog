...
### 2026-04-12: en-US メタデータの法的リンク漏れで App Store リジェクト (Guideline 3.1.2(c))
- **状況**: ローカライズ時に ja 他17言語の description.txt にはフッターリンク (Privacy Policy / Terms of Use) を追加したが、en-US の原文に追加し忘れた。en-US の privacy_url.txt も空のままだった
