...
## 1. Repologとは（1行で）
**「現場で撮った写真とコメントを、A4縦の“提出に強いPDFレポート”に一発でまとめるアプリ」**
...
### 11-4. 4P分析
- Product：A4縦提出、コメント、写真（欠けない）、OS保存、バックアップ
