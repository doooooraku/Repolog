...
| 旧付録 | 移動先 | 内容 |
|--------|--------|------|
| 付録A: PDF仕様 | [`docs/reference/basic_spec.md`](../reference/basic_spec.md)（PDF生成） | 用紙/ページ構成/ファイル名 |
...
| 付録E: ワイヤーフレーム | [`docs/how-to/archive/wireframes.md`](../how-to/archive/wireframes.md) | 画面設計図 |
