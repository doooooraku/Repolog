...
const dict = {
  ...
  paywallFreeLabel: '免費',
  paywallProLabel: 'Pro',
  paywallFeaturePhotos: '每份報告照片數',
  paywallFeaturePhotosFree: '最多10張',
  paywallFeaturePhotosPro: '無限制',
  ...
  paywallFeatureAds: '廣告',
  paywallFeatureAdsFree: '橫幅廣告',
  paywallFeatureAdsPro: '無廣告',
  priceLoading: '載入中...',
