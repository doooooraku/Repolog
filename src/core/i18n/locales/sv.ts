...
const dict = {
  ...
  paywallFeaturePhotosFree: 'Upp till 10',
  paywallFeaturePhotosPro: 'Obegränsat',
  ...
  paywallFeatureAds: 'Annonser',
  paywallFeatureAdsFree: 'Bannerannonser',
  paywallFeatureAdsPro: 'Inga annonser',
