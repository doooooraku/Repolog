...
const dict = {
  ...
  paywallFeaturePhotosFree: 'Maks. 10',
  paywallFeaturePhotosPro: 'Tak terbatas',
  ...
  paywallFeatureAds: 'Iklan',
  paywallFeatureAdsFree: 'Banner iklan',
  paywallFeatureAdsPro: 'Tanpa iklan',
