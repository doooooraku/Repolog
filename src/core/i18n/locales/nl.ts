...
const dict = {
  ...
  settingsBackupDesc: 'Exporteer of importeer een back-up van je rapporten en foto\'s.',
  ...
  paywallFeaturePhotosFree: 'Max. 10',
  paywallFeaturePhotosPro: 'Onbeperkt',
  ...
  paywallFeatureAds: 'Advertenties',
  paywallFeatureAdsFree: 'Banneradvertenties',
  paywallFeatureAdsPro: 'Geen advertenties',
  ...
  backupExportDesc: 'Maakt een back-upbestand met alle rapporten en foto\'s. PDF\'s worden niet meegenomen.',
