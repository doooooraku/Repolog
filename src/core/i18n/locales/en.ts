const baseEn = {
  ...
  paywallYearlySavings: 'Get about 2 months free!',
  ...
  paywallFeatureLayout: 'Large layout',
  paywallFeatureLayoutFree: 'Preview only',
  paywallFeatureLayoutPro: 'Export ready',
