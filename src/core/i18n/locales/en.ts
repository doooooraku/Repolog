const baseEn = {
  ...
  homeFiltersTitle: 'Filters',
  homeFilterFromLabel: 'From',
  homeFilterToLabel: 'To',
  homeFilterDatePlaceholder: 'YYYY-MM-DD',
  homeFilterTagPlaceholder: 'Filter by tags...',
  homeFilterPinnedOnlyLabel: 'Pinned only',
  homeFilterResetAction: 'Clear filters',
