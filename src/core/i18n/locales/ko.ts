...
const dict = {
  ...
  paywallFreeLabel: '무료',
  paywallProLabel: 'Pro',
  paywallFeaturePhotos: '보고서당 사진 수',
  paywallFeaturePhotosFree: '최대 10장',
  paywallFeaturePhotosPro: '무제한',
  ...
  paywallFeatureAds: '광고',
  paywallFeatureAdsFree: '배너 광고',
  paywallFeatureAdsPro: '광고 없음',
  priceLoading: '로딩 중...',
